...
autocmd FileType clojure nnoremap <buffer> <silent> <localleader>rs :Dispatch clojure -Ascotch -Sdeps '{:deps {cider/cider-nrepl {:mvn/version "0.18.0-SNAPSHOT"}, org.clojure/tools.namespace {:mvn/version "0.2.11"}}}' -e '(require (quote cider-nrepl.main)) (cider-nrepl.main/init ["cider.nrepl/cider-middleware"])'<cr>
